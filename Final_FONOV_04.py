...
if page == "Задание 3":
    ...
    h0 = st.number_input('Введите энтальпия полного торможения перед первой нерегулируемой ступенью h0_, кДж/кг', value=3410.96)
    Pz = st.number_input('Введите давление за ЦВД, МПа ', value=4.86)
