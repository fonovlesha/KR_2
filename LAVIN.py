...
if page == "Задание 2":
    ...
    Ne = 810*(10**6)#st.number_input('Введите мощность Nэ, МВт', value=810) * 10 ** 6


    p_0 = 24.2 #st.number_input('Введите давление P0, МПа', value=24.2)
    t_0 = 550 #st.number_input('Введите температуру T0, °C', value=550)
    T_0 = t_0 + 273.15
...
if page == "Задание 3":
    ...
    G0 = st.number_input('Введите расход пара в первую нерегулируемую ступень G0, кг/с', value=656.17)
